...
const routes = [
   ...
   { path: '/login', component: require('../changepassword/login.vue')},
   { path: '/sendemail', component: require('../changepassword/sendemail.vue')},
   { path: '/verifycode', component: require('../changepassword/verifycode.vue')},
